...
namespace IngameScript.TargetTracking
{
    ...
    public class LidarPool
    {
        ...
        SortedList<ValueTuple<long, long>, IMyCameraBlock> LidarQueue;
        ...
        public LidarPool(Func<long> getcurrenttime)
        {
            ...
            LidarQueue = new SortedList<ValueTuple<long, long>, IMyCameraBlock>();
        }
        ...
        {
            KeyValuePair<ValueTuple<long, long>, IMyCameraBlock>? found = null;
            foreach (KeyValuePair<ValueTuple<long, long>, IMyCameraBlock> pair in LidarQueue)
            {
        ...
        public long addToLidarPool(IMyCameraBlock c)
        {
            ...
            LidarQueue.Add(new ValueTuple<long, long>(timestamp, addedCount++), c);
            return timestamp;
        }
    }
